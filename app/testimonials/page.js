  ...
  const testimonialImages = [
    {
      id: 1,
      name: "לקוח ממליץ 1",
      image: "IMG_0267_fqpkhl",
      company: "חתונה - תל אביב",
    },
    {
      id: 2,
      name: "לקוח ממליץ 2",
      image: "IMG_0266_glskbe",
      company: "יום הולדת 30 - ירושלים",
    },
    {
      id: 3,
      name: "לקוח ממליץ 3",
      image: "IMG_0262_t7onux",
      company: "אירוע חברה - חיפה",
    },
    {
      id: 4,
      name: "לקוח ממליץ 4",
      image: "IMG_0263_xrxccp",
      company: "בר מצווה - אשדוד",
    },
    {
      id: 5,
      name: "לקוח ממליץ 5",
      image: "IMG_0264_xjptwr",
      company: "אירוע גיבוש - באר שבע",
    },
    {
      id: 6,
      name: "לקוח ממליץ 6",
      image: "IMG_0256_wlzwbl",
      company: "חתונה - נתניה",
    },
    {
      id: 7,
      name: "לקוח ממליץ 7",
      image: "IMG_0261_o2bftt",
      company: "יום הולדת 40 - רמת גן",
    },
    {
      id: 8,
      name: "לקוח ממליץ 8",
      image: "IMG_0251_tktvj8",
      company: "אירוע חברה - הרצליה",
    },
    {
      id: 9,
      name: "לקוח ממליץ 9",
      image: "IMG_0254_cwu4k6",
      company: "בר מצווה - כפר סבא",
    },
    {
      id: 10,
      name: "לקוח ממליץ 9",
      image: "IMG_0257_nybdbg",
      company: "בר מצווה - כפר סבא",
    },
    {
      id: 11,
      name: "לקוח ממליץ 9",
      image: "IMG_0253_q8nzai",
      company: "בר מצווה - כפר סבא",
    },
    {
      id: 12,
      name: "לקוח ממליץ 9",
      image: "IMG_0246_hehhtd",
      company: "בר מצווה - כפר סבא",
    },
    {
      id: 13,
    ...
    },
    {
      id: 14,
      name: "לקוח ממליץ 9",
      image: "IMG_0248_ktzpuy",
      company: "בר מצווה - כפר סבא",
    },
    {
      id: 15,
      name: "לקוח ממליץ 9",
      image: "IMG_0249_fu1ojc",
      company: "בר מצווה - כפר סבא",
    },
    {
      id: 16,
      name: "לקוח ממליץ 9",
      image: "IMG_0247_jw5w2b",
      company: "בר מצווה - כפר סבא",
    },
  ];
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${getCloudinaryUrl("backgroundM_5_icgj9l")})`,
          }}
        ></div>
        ...
        <button
          ...
          className="absolute top-8 right-8 z-20 bg-black bg-opacity-50 hover:bg-opacity-70 text-white p-3 rounded-full transition-all duration-300 transform hover:scale-110"
        >
          <svg
            className="w-6 h-6"
            fill="none"
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.202 12 3.665 12 5v14c0 1.335-1.077 1.798-1.707 1.293L5.586 15z"
            />
          </svg>
        </button>

        {/* Desktop Layout - Phone Frame + Content Side by Side */}
        <div className="hidden lg:flex absolute inset-0 items-center justify-center gap-16">
          {/* Background Image with Overlay */}
          <div
            className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-30"
            style={{
              backgroundImage: `url(${getCloudinaryUrl(
                "backgroundM_5_icgj9l"
              )})`,
            }}
          ></div>
          {/* Content Overlay */}
          <div className="relative z-10 flex items-center justify-center gap-16">
            {/* Realistic iPhone Frame with Video - Left Side */}
            <div
              className="relative"
                      ...
                      <div className="relative bg-black rounded-[2.8rem] overflow-hidden w-full h-full shadow-inner">
                        ...
                        <video
                          src={getCloudinaryUrl({
                            type: "video",
                            src: "WhatsApp_Video_2025-08-24_at_17.30.29_cd6f9242_tzfkg2",
                          })}
            ...
            <div className="text-white text-right max-w-2xl">
              ...
              >
                מה הלקוחות שלנו אומרים על השירות שלנו
              </p>
              <button
                onClick={() =>
                  document
                ...
                className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl animate-fade-in-up"
        ...
        {/* Mobile Layout - Full Video Background */}
        <div className="lg:hidden absolute inset-0 flex items-center justify-center">
          {/* Full Video Background for Mobile */}
          <video
            src={getCloudinaryUrl({
              type: "video",
              src: "WhatsApp_Video_2025-08-24_at_17.30.29_cd6f9242_tzfkg2",
      ...
      {/* Testimonials Images Grid Section */}
      <section id="testimonials-section" className="py-20 bg-gray-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonialImages.map((item, index) => (
              <div
                ...
                onClick={() => {
                  trackCustomEvent("TestimonialImageClick", {
              ...
              >
                <div className="relative overflow-hidden rounded-lg shadow-xl">
                  <img
                    ...
                    alt={item.name}
                    className="w-full h-[700px] object-cover transition-transform duration-300 group-hover:scale-110"
                  />
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-gray-300 mb-8">
            הצטרפו למאות לקוחות מרוצים שכבר חוו את הקסם שלנו
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                trackCustomEvent("NavigationFromTestimonials", {
                  from: "testimonials",
                  to: "home",
                  action: "back_button",
                });
            ...
            <button
              ...
              className="bg-gray-700 hover:bg-gray-600 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              הזמנת אטרקציות
            </button>
            <a
              ...
              className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
      ...
      {/* Copy Link Button */}
      <CopyLinkButton pageName="testimonials_page" />
